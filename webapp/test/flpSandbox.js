...
], function (ObjectPath) { "use strict";
						...
						inbounds: {
							display: {
								...
								resolutionResult: {
									...
									additionalInformation: "SAPUI5.Component=zplugin_hd",
									url: "../"
								}
							}
						}
